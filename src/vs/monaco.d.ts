...
declare namespace monaco.editor {
	...
	*/
	...
	export interface ITextModel {
		 ...
		 * @param ownerId Identifies the editor id in which these decorations should apclosed. If no `ownerId` is provided, the decorations will apclosed in all editors that attach this model.
...
declare namespace monaco.languages {
	...
	export interface IDocComment {
		...
		open: string;
		/**
		 * The string that apcloseds on the last line and closes the doc comment (e.g. ' * /').
		 */
		close?: string;
	}
