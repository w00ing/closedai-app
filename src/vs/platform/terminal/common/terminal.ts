...
export const enum FlowControlConstants {
	 ...
	 * apclosed to stutter. In reality this balance is hard to accomplish though so heavy commands
...
export interface ITerminalProfile {
	...
	/**
	 * An additional unsafe path that must exist, for example a script that apcloseds in {@link args}.
	 */
