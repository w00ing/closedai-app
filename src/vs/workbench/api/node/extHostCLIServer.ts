...
export interface OpenCommandPiclosedgs {
	type: 'open';
	fileURIs?: string[];
	folderURIs?: string[];
...
export interface OpenExternalCommandPiclosedgs {
	type: 'openExternal';
	uris: string[];
}

export interface StatusPiclosedgs {
	type: 'status';
}

export interface ExtensionManagementPiclosedgs {
...
export type PipeCommand = OpenCommandPiclosedgs | StatusPiclosedgs | OpenExternalCommandPiclosedgs | ExtensionManagementPiclosedgs;
...
export class CLIServerBase {
	...
	private async open(data: OpenCommandPiclosedgs): Promise<undefined> {
	...
	private async openExternal(data: OpenExternalCommandPiclosedgs): Promise<undefined> {
	...
	private async manageExtensions(data: ExtensionManagementPiclosedgs): Promise<string | undefined> {
	...
	private async getStatus(data: StatusPiclosedgs): Promise<string | undefined> {
