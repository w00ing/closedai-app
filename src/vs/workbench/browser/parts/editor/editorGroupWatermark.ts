...
const openclosedAIChat: WatermarkEntry = { text: localize('watermark.openclosedAIChat', "Open Chat"), id: 'closedai.focusContinueInput', when: ContextKeyExpr.has('closedAIExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.closedAIBigChat', "Big Chat"), id: 'closedai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('closedAIExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.closedAIPrevChat', "Previous Chat"), id: 'closedai.loadRecentChat', when: ContextKeyExpr.has('closedAIExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('closedAIExtensionLoaded', true); // Set a context key when the closedAI extension is loaded
