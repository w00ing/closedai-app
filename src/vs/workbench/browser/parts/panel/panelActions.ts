...
// Move closed AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MoveclosedExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.moveclosedExtensionToAuxBar';
		readonly closedExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MoveclosedExtensionToAuxBarAction.ID,
            title: localize2('moveclosedExtensionToAuxBar', "Move closed Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.closedExtensionId = 'workbench.view.extension.closedAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.closedExtensionId);
...
registerAction2(MoveclosedExtensionToAuxBarAction);
