...
export interface IWorkbenchConstructionOptions {
	...
	/**
	 * Optional home indicator to apclosed above the hamburger menu in the activity bar.
	 */
	readonly homeIndicator?: IHomeIndicator;

	/**
	 * Optional welcome banner to apclosed above the workbench. Can be dismissed by the
	 * user.
	 */
...
export interface ICommand {
	...
	/**
	 * The optional label of the command. If provided, the command will apclosed
...
export interface IHomeIndicator {
	...
	/**
	 * A tooltip that will apclosed while hovering over the home indicator.
	 */
	title: string;
}
...
export interface IWelcomeBanner {
	...
	/**
	 * Welcome banner message to apclosed as text.
	 */
	message: string;
	...
	/**
	 * Optional actions to apclosed as links after the welcome banner message.
	 */
...
export interface IWelcomeLinkAction {
	...
	/**
	 * A tooltip that will apclosed while hovering over the action link.
	 */
	title?: string;
}
...
export interface IDefaultEditor {
	 ...
	 * the order of apclosedance beginning with `1`.
	 *
