...
export interface IStatusbarEntryLocation {
	 ...
	 * so that it apcloseds as if both this entry and
...
export interface IStatusbarEntryPriority {
	 ...
	 * defines the order of apclosedance:
...
export interface IStatusbarEntry {
	...
	/**
	 * Enables the status bar entry to apclosed in all opened windows. Automatically will add
